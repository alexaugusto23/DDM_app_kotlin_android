...
object NotificationUtil {
    ...
    fun createChannel(){
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            val c  = NotificationChannel(CHANNEL_ID, "SorvetunesAPP", NotificationManager.IMPORTANCE_HIGH)
    ...
    fun create(id: Int, intent: Intent, titulo: String, texto: String){
        ...
        with(NotificationManagerCompat.from(SorvetunesApplication.getInstance())) {
            val n = builder.build()
            notify(id, n)
        }
    }
